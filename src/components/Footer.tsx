      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-semibold mb-4">Bay Area Yoga</h3>
            <p className="text-white/90 mb-4">
              Dedicated to bringing peace, health, and wellness to the Bay Area community
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/90">
              ...
              <li>Email: contact@bayareayoga.com</li>
            </ul>
          </div>
        </div>

        <div className="mt-8 pt-8 border-t border-white/20 text-center text-white/90 text-sm">
          <p>&copy; {new Date().getFullYear()} Bay Area Yoga. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
